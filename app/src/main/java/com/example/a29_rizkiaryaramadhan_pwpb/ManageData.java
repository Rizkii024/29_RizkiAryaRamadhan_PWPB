package com.example.a29_rizkiaryaramadhan_pwpb;
...
public class ManageData extends AppCompatActivity {
    ...
    private void initbtn(Button btn,final Class kiw,final String act){
        confirm.setText(act);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent pindah = new Intent(ManageData.this,kiw);
                startActivity(pindah);
            }
        });
    }
